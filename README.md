...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tokenize-output-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10735&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tokenize-output-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tokenize-output` can be installed with:

```
conda install tokenize-output
```

It is possible to list all of the versions of `tokenize-output` available on your platform with:
